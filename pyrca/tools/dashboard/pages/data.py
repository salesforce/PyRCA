...
def create_control_panel() -> html.Div:
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                children=[
                    html.Button(id="thres-btn", children="Estimate", n_clicks=0)
                ],
                style={"textAlign": "center"}
            ),
            ...
            html.Div(
                children=[
                    html.Button(id="manual-btn", children="Test", n_clicks=0)
                ],
                style={"textAlign": "center"}
            ),
